...
| You want one holistic decomposition (multi-stage pipeline) | You prefer smaller, per-goal LLM contexts |
...
`summary.yaml` (id `3`) includes a multi-goal example with cross-goal dependencies.

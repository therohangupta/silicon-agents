...
def get_allocator(allocation_strategy: int, db_url: str = None, registry: Optional[AgentInstanceRegistry] = None):
    ...
    elif allocation_strategy == fleet_manager_pb2.AllocationStrategy.DETERMINISTIC:
        from .types.deterministic.allocator import DeterministicAllocator
        return DeterministicAllocator(db_url, registry=registry)

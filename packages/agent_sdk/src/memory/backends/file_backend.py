...
class FileMemoryBackend(MemoryBackend):
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        """``FileMemoryBackend`` — agent_fleet packages helper; see body comments for step-by-step behavior."""
    ...
    def _path(self, store: MemoryStoreConfig) -> Path:
        """``_path`` — agent_fleet packages helper; see body comments for step-by-step behavior."""
    ...
    def _save(self, store: MemoryStoreConfig, data: Any) -> None:
        """``_save`` — agent_fleet packages helper; see body comments for step-by-step behavior."""
        p = self._path(store)

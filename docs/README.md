...
Design and operational notes for **repo root**. This file is an **index only**; the documents linked below are the sources of truth. Do not treat this README as a substitute for reading those pages when debugging production or onboarding to the control plane.

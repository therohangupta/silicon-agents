...
This module defines the specialist that authors directed tests and constrained-random UVM sequences for coverage-driven verification on the frontend
...
class StimulusAgent(EdaAgent):
    """Stimulus Agent — Create directed tests and constrained-random sequences aimed at coverage holes.

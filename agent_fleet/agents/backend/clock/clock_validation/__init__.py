"""Package export for the Clock Validation Agent.

This ``__init__`` re-exports ``ClockValidationAgent`` so fleet scanners and tests can import the
agent class from the package root of ``clock_validation/``. Importing this

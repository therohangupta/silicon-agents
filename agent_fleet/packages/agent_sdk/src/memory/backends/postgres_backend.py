...
class PostgresMemoryBackend(MemoryBackend):
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        """``PostgresMemoryBackend`` — agent_fleet packages helper; see body comments for step-by-step behavior."""
    ...
    async def _pool_connect(self) -> Any:
        """``_pool_connect`` — agent_fleet packages helper; see body comments for step-by-step behavior."""
    ...
    async def _ensure_schema(self) -> None:
        """``_ensure_schema`` — agent_fleet packages helper; see body comments for step-by-step behavior."""
    ...
    def _serialize(value: Any) -> str:
        """``_serialize`` — agent_fleet packages helper; see body comments for step-by-step behavior."""
        return json.dumps(value)

    @staticmethod
    def _deserialize(raw: str | None) -> Any:
        """``_deserialize`` — agent_fleet packages helper; see body comments for step-by-step behavior."""
        if raw is None:

...
Turns bring-up intent into versioned lab procedures with prerequisites, safe voltage/current/temperature bounds, expected observations, rollback, and approval points. Bounds may only be copied from approved limits.

This module defines the concrete ``LabProcedureAgent`` subclass of ``EdaAgent``.
...
Original short description preserved for continuity: Lab Procedure Agent.
"""
...
class LabProcedureAgent(EdaAgent):
    """Lab Procedure specialist bound to this directory's fleet manifest.

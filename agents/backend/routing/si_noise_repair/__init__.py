"""Package export for the SI/Noise Repair Agent.

This ``__init__`` re-exports ``SiNoiseRepairAgent`` so fleet scanners and tests can import the
agent class from the package root of ``si_noise_repair/``. Importing this

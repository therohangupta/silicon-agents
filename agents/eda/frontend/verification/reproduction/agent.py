...
This module defines the specialist that shrinks failing seeds and waveforms so defects can be handed to RTL or TB owners on the frontend
...
class ReproductionAgent(EDAAgent):
    """Reproduction Agent — Produce a minimal stable reproduction and a waveform slice for one failure cluster.

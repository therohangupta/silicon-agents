...
This module defines the specialist that builds the SystemVerilog UVM testbench environment around the DUT interfaces on the frontend
...
class UvmEnvironmentAgent(EDAAgent):
    """UVM Environment Agent — Generate and maintain drivers, monitors, scoreboards, and sequences for one block.

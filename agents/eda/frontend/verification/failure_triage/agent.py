...
This module defines the specialist that groups failing simulations by signature and routes clusters to RTL, TB, or infrastructure owners on the frontend
...
class FailureTriageAgent(EDAAgent):
    """Failure-Triage Agent — Cluster failures and assign a likely owner with confidence and evidence.

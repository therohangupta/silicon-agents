...
This module defines the specialist that authors the golden behavioral model used for transaction-level checking on the frontend
...
class ReferenceModelAgent(EDAAgent):
    """Reference Model Agent — Produce an executable behavioral reference model from the specification.

...
Plans and executes PVT/workload sweeps inside approved bounds, fits the operating envelope and guardband, and compares measured distributions to pre-silicon predictions.

This module defines the concrete ``CharacterizationAgent`` subclass of ``EDAAgent``.
...
Original short description preserved for continuity: Characterization Agent.
"""
...
class CharacterizationAgent(EDAAgent):
    """Characterization specialist bound to this directory's fleet manifest.
    ...
    Purpose:
        ...
        boundaries for characterization.

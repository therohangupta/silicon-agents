...
from ..config.models import EDAEngineeringContext
...
class ContextService:
    ...
    async def assemble(
        ...
        *,
        ...
        Args:
            ...
            policy: EDA engineering context from ``EDAAgentConfig.context``.
    ...
    def _in_scope(self, record: MemoryRecord, task: TaskBrief) -> bool:
    ...
    def _keep(self, record: MemoryRecord, task: TaskBrief, exclude: Sequence[str]) -> bool:
